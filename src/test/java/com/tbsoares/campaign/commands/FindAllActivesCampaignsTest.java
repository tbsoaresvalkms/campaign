...
public class FindAllActivesCampaignsTest {
    @Mock
    ...
    @Test
    public void shouldFindAllCampaigns() {
        ...
        Mockito.when(campaignRepository.findAllByEndDateGreaterThanEqual(LocalDate.now()))
                .thenReturn(campaigns);

        List<CampaignResource> campaignResources = findAllActivesCampaigns.execute();
